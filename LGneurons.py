...
import nstrand
from solutionDict import * # contain the solution of the population model ordered in a dictionary
import nest
import numpy as np
...
def computeW(listRecType,nameSrc,nameTgt,inDegree,gain=1.,verbose=False):
  ...
  if nameSrc == 'GTI' and (nameTgt == 'GTA' or nameTgt == 'GTI') :
      gain = 4/5.
  elif nameSrc == 'GTA' and (nameTgt == 'GTA' or nameTgt == 'GTI'):
      gain = 1/5.
